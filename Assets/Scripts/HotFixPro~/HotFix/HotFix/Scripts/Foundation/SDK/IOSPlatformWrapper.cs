...
public class IOSPlatformWrapper:MonoBehaviour{
    ...
    private static System.Action initCallBack;
    ...
    //ABTest
    [DllImport("__Internal")]
    private static extern bool HwABTest();
    ...
    public  void initSDK(System.Action actionCallBack = null)
    {
        Debug.Log("initSDK");
        initCallBack = actionCallBack;
