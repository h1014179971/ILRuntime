...
public class AndroidPlatform : PlatformFactory
{
    ...
    public override void initSDK(System.Action actionCallBack = null)
    {
        AndroidPlatformWrapper.Instance.initSDK(actionCallBack);
    }
    ...
    public override bool GameABTest()
    {
        Debug.Log("AndroidPlatform GameABTest");
        return AndroidPlatformWrapper.Instance.GameABTest();
    }
