...
namespace Foundation
{
    public class StreamFile
    {
        ...
        public static void RecordFileWithoutEncry(object jsonObj, string name)
        {
            name = name.Replace('\\', '/');
            string[] directoryPaths = name.Split('/');
            string directory = "";
            ...
            StreamWriter streamsave = new StreamWriter(path, false, System.Text.Encoding.Default);
            streamsave.Write(jsonStr);
            streamsave.Close();
